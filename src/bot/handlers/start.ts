...
💬 Просто отправьте мне сообщение, и я отвечу!`;
    ...
    // Новый пользователь - предлагаем варианты получения доступа
    const registrationMessage = `🔐 <b>Добро пожаловать в AI чат-бот!</b>

Для начала работы вам необходим ключ доступа.

📝 <b>Варианты получения доступа:</b>

🔑 <b>У вас уже есть ключ?</b>
Нажмите кнопку "Ввести ключ" и отправьте его

📨 <b>Нужен доступ?</b>
Нажмите кнопку "Запросить доступ" - ваш запрос будет отправлен администраторам

⏱️ <b>Время рассмотрения:</b> обычно до 24 часов`;
